...
mpv_binary = "umpv" if shutil.which("umpv") else "mpv" if shutil.which("mpv") else None
...
c.aliases['freezer'] = 'hint all userscript freezer'
...
c.colors.tabs.bar.bg = '#202D32'

## Background color of unselected even tabs.
## Type: QtColor
c.colors.tabs.even.bg = '#314046'
...
## Type: QtColor
c.colors.tabs.selected.even.bg = '#B5BD68'
...
## Type: QtColor
c.colors.tabs.selected.odd.bg = '#B5BD68'
...
config.set('content.headers.user_agent',
           'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36 ', # Chrome 75.0 Linux
           'web.whatsapp.com')
...
## Type: FuzzyUrl
c.url.default_page = 'https://apetresc-site.s3.amazonaws.com/home.html'
...
c.url.searchengines = {
    ...
    'wp': 'https://secure.wikimedia.org/wikipedia/en/w/index.php?title=Special%%3ASearch&search={}',
    'g':  'https://www.google.com/search?hl=en&source=hp&ie=ISO-8859-l&q={}',
    'r':  'https://reddit.com/r/{}',
    'jira': 'https://rubikloud.atlassian.net/browse/{}',
    'docker': 'https://hub.docker.com/search?q={}&type=image'
}

## The page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ['https://apetresc-site.s3.amazonaws.com/home.html']
...
config.unbind('xO')
config.unbind('xo')
config.bind('<Ctrl-\\>', 'config-cycle tabs.show always switching')
config.bind('<Ctrl-\\>', 'config-cycle tabs.show always switching', mode='insert')
config.bind('<Ctrl-b>', 'config-cycle statusbar.hide')
...
config.bind('gi', "fake-key 'gi'")
config.bind('`', "fake-key '`'")
config.bind('<Return>', "fake-key '<Return>'", mode='normal')

config.bind('m', 'spawn %s {url}' % mpv_binary)
config.bind('M', 'hint links spawn %s {hint-url}' % mpv_binary)
config.bind(';M', 'hint --rapid links spawn %s {hint-url}' % mpv_binary)
config.bind('<Ctrl-p>', 'spawn -m /home/apetresc/.local/bin/wallabag add {url}')
config.bind('<Ctrl-r>', 'spawn --userscript qute-bitwarden')
config.bind('<Ctrl-z>', 'spawn --userscript qute-zotero')
